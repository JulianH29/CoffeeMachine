...
public class CoffeeMachine {
	...
	public static void remaining() {
		...
		System.out.println(water + " Water remainig in the machine");
		System.out.println(milk + " Milk remainig in the machine");
		System.out.println(coffeeBeans + " Coffee Beans remainig in the machine");
		System.out.println(disposableCups + " Disposable cups remainig in the machine");
	...
	public static void buy() {
		...
		System.out.println("What would you like to purchace:");
